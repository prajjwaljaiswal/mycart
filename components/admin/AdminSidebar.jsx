...
import { HomeIcon, ShieldCheckIcon, StoreIcon, TicketPercentIcon, CreditCardIcon } from "lucide-react"
...
const AdminSidebar = () => {
    ...
    const sidebarLinks = [
        ...
        { name: 'Payment Gateway Config', href: '/admin/payment-gateway-config', icon: CreditCardIcon },
    ]
